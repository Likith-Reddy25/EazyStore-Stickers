...
export default function CheckoutForm() {
  ...
  const labelStyle =
    "block text-lg font-semibold text-primary mb-2";
  ...
  const fieldValidClass =
    "border-primary focus:ring-dark ";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-primary">
      ...
      >
        <p className="mt-4 text-2xl font-normal text-primary ">
      ...
      <div
        className={
          isProcessing
            ? "hidden"
            : "visible bg-white  shadow-md rounded-lg max-w-md w-full px-8 py-6"
        }
      >
        <PageTitle title="Complete Your Payment" />

        <p className="min-h-max text-center mt-8 text-lg text-gray-600  mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button
              ...
              className="w-full px-6 py-2 mt-6 text-white text-xl bg-primary  hover:bg-dark rounded-md transition duration-200"
            >
