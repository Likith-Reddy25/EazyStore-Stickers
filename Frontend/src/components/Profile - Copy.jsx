...
export default function Profile() {
  ...
  useEffect(() => {
    if (actionData?.success) {
      if (actionData.profileData.emailUpdated) {
        ...
        //Updating the suer object in auth context and localStorage
  ...
  const h2Style =
    "block text-2xl font-semibold text-primary";
  ...
  return (
    <div className="max-w-[1152px] min-h-[852px] mx-auto px-6 py-8 font-primary bg-normalbg ">
      ...
      <Form method="PUT" className="space-y-6 max-w-[768px] mx-auto">
        ...
        <div className="text-center">
          <button
            ...
            className="px-6 py-2 mt-8 text-white  text-xl rounded-md transition duration-200 bg-primary  hover:bg-dark"
          >
