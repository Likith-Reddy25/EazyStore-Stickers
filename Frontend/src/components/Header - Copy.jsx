...
export default function Header() {
  ...
  return (
    <header className="border-b border-gray-300  top-0 z-20 bg-normalbg ">
            ...
            <li>
              {isAuthenticated ? (
                <div className="relative" ref={userMenuRef}>
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute right-0 w-48 bg-normalbg \ border-gray-300  rounded-md shadow-lg z-20 transition ease-in-out duration-200">
                      <ul className="py-2">
                        <li>
