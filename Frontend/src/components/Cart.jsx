...
export default function Cart() {
  ...
  return (
    <div className="min-h-[852px] py-12 bg-normalbg font-primary">
        ...
        {!isCartEmpty ? (
          ...
          {isAddressIncomplete && (
            <p className="text-red-500 text-lg mt-2 text-center">
              Please update your address in your profile to checkout
            </p>
          )}
            <CartTable />
            <div className="flex justify-between mt-8 space-x-4">
              ...
              <Link
                to="/home"
                className="py-2 px-4 bg-primary  text-white  text-xl font-semibold rounded-sm flex justify-center items-center hover:bg-dark  transition"
              >
                Back to Products
              </Link>
